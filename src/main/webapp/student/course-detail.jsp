...
<%
	...
	//요청 URL
	// localhost/app5/student/course-list.jsp?cno=xxx
	...
	if(loginId !=null){
		...
		Registration reg = registrationDao.getRegistrationByCourseAndStudent(courseNo,loginId);
		if(reg !=null){
...
%>			
			<a href="course-request.jsp?cno=<%=course.getNo() %>" 
				class="btn btn-success btn-sm"><%=course.getQuota() == course.getReqCnt() ? "disabled" : "" %>
				수강신청
			</a>
<%
	}
